...
language: python3
important note: when you import the function to the terminal python3
environment and if you change anything inside the code you need to
import it again. otherwise you won't have those changes.
...
def text_analyzer(_string="") -> None:
    ...
    print("- ", counter[4], " digits(s)")


def main() -> None:
    """
        This function is made to shorten the length of
